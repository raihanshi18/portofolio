        ...
        <>
            ...
            >
                <div className="px-24 pt-14 flex items-start gap-16">
                    <h1
                        onClick={handleClose}
                        className="text-5xl font-black leading-none cursor-pointer hover:text-transparent hover:[-webkit-text-stroke:2px_white] hover:[paint-order:stroke] duration-500 select-none"
                    >
                        HAN<br />ABDUR<br />SHI.
                    </h1>
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <p
                                    ...
                                    className={`text-sm transition-transform flex items-center gap-3 select-none ${isActive
                ...
                <div className="px-24 mt-12 overflow-hidden">
                    ...
                    <div className={`transition-all duration-350 ease-[cubic-bezier(0.76,0,0.24,1)] ${activeItem === 'about' && !isTransitioning
                        ...
                        <div className="max-w-xl">
                            ...
                            <div className="overflow-hidden">
                                <p className={`text-xs leading-relaxed transition-all duration-500 delay-[120ms] ease-[cubic-bezier(0.76,0,0.24,1)] ${activeItem === 'about' && !isTransitioning ? 'translate-y-0 opacity-80' : 'translate-y-full opacity-0'}`}>
            ...
            {(isExperience || isProject) && (
                <div className={`fixed top-0 left-0 px-24 pt-10 z-50 text-white font-clash transition-all duration-500 ${isOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
                    <h1 className={`text-5xl font-black leading-none cursor-pointer select-none transition-all duration-500 ${isScrolled
                ...
                <div>
                    {!isExperience || isProject && (
                        <div className="w-[300px]">
                            <h1 className="text-5xl font-black leading-none pb-4 cursor-pointer hover:text-transparent hover:[-webkit-text-stroke:2px_white] hover:[paint-order:stroke] duration-500 select-none">
                                <a href="/">HAN<br />ABDUR<br />SHI.</a>
                            </h1>
                        </div>
                    )}
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <div className={`${!isExperience ? 'mt-6' : ''} text-xs grid grid-cols-3 gap-x-20 gap-y-2`}>
                                <p>Student of Software Engineering</p>
                                <p>Bandung, West Java</p>
                                <p
